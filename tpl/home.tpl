            ...
            <div class="w3-content w3-row" style="max-width:600px; max-height:750px; height:100%">
                ...
                <div class="w3-rest" style="height:100%">
                    <div class="w3-border" style="height:95%">
                        <div class="w3-row w3-border-bottom w3-padding-large" style="height:20%">
                            <div class="w3-col s4">
                                <div class="w3-circle w3-border w3-left w3-container w3-center" style="height:120px; width:120px">
                                    <p>Stemma</p>
                                </div>    
                            </div>
                            <div class="w3-col s8 w3-container w3-padding-large">
                                <h3>Trento UniCittà</h3>
                            </div>
                        </div>
